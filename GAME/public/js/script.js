(function () {
  ...
  class Pontuacao {
    constructor () {
        ...
        this.element.style.right = `${gameDimensions[0]-1174}px`;
        this.element.style.bottom =`${gameDimensions[1]-500}px`;
  ...
  class GameOver {
    constructor () {
      ...
      //this.element.appendChild(document.createTextNode("Tá pegando fogo, bicho!"));
  ...
  function run () {
    ...
    if(Math.random() * 150 < probFoco){
      surge = setTimeout(SurgirCaveira, (2000/InteiroAleatorio(1,4))/FPS);
    }
  }
